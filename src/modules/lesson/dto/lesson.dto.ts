...
export class CreateLessonDto {
  ...
  @ApiProperty({ description: 'Lesson title', example: 'Introduction to Marketing' })
  @IsString()
  @IsNotEmpty()
  title: string;
  ...
  @ApiPropertyOptional({ description: 'Main content paragraphs', type: [String] })
  @IsArray()
  @IsString({ each: true })
  @IsOptional()
  main_content?: string[];
  ...
  @ApiPropertyOptional({ description: 'Lesson status', enum: ['draft', 'published'], default: 'draft' })
